    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">This catalogue may not exist or may no longer be available.</p>
        ...
        <div className="max-w-md w-full">
          <div className="bg-white rounded-lg shadow-md p-8">
            <div className="text-center mb-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Private Catalogue</h2>
              <p className="text-gray-600">This catalogue is password protected</p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm text-orange-600 font-medium">Private Collection</span>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <div className="flex items-center mb-4">
                <h1 className="text-3xl font-bold text-gray-900">{catalogue.title}</h1>
                <div className="ml-4 bg-orange-100 text-orange-800 px-2 py-1 rounded text-sm font-medium">
                  Private
                </div>
              </div>
